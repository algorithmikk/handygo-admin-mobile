        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput style={styles.input} placeholder={t('auth.email')} placeholderTextColor={Colors.gray[400]}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput style={styles.input} placeholder={t('auth.password')} placeholderTextColor={Colors.gray[400]}
            ...
            <TouchableOpacity style={styles.loginButton} onPress={handleLogin} disabled={isLoading}>
              {isLoading ? <ActivityIndicator color={Colors.white} /> : <Text style={styles.loginButtonText}>{t('auth.login')}</Text>}
            </TouchableOpacity>

            <View style={styles.demoHint}>
              <Text style={styles.demoText}>Demo: admin@handygo.ae / admin123</Text>
            </View>
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  logoContainer: { width: 56, height: 56, borderRadius: 16, backgroundColor: Colors.primary[500], alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.slate[800], borderRadius: 12, borderWidth: 1, borderColor: Colors.gray[700], marginBottom: 16, paddingHorizontal: 16 },
  ...
  loginButton: { backgroundColor: Colors.primary[500], borderRadius: 12, height: 52, alignItems: 'center', justifyContent: 'center' },
